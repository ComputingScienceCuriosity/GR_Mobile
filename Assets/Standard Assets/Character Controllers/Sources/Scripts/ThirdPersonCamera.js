...
function SetUpRotation (centerPos : Vector3, headPos : Vector3)
{
	...
	var yRotation = Quaternion.LookRotation(Vector3(offsetToCenter.x, 0, 0));
...
function SetUpRotation (centerPos : Vector3, headPos : Vector3)
{
	...
	var relativeOffset = Vector3.forward * distance + Vector3.down * height;
	cameraTransform.rotation = Quaternion.Euler(22.5, 90, 0);//yRotation * Quaternion.LookRotation(relativeOffset);
